 ...
 */
public class BookHisAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BookHisAdapter(Activity context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_book_his, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((ViewHolder) holder).btnStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, ActBookingDetail.class).putExtra("data", histories.get(position)).putExtra("fromHis", true));
            }
        });
    }
