 ...
 */
public class FragBookHis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainPresenter.getBookHis(PreferenceUtility.getInstance().loadDataString(getContext(), PreferenceUtility.ACCESS_TOKEN), sdr.format(lastYear), sdr.format(today), "2,3,4", "en");
    ...
    public void initRecyclerView() {
        ...
        historyAdapter = new BookHisAdapter(getActivity());
